...
const app = initializeApp({ projectId: "shoplift-dev" });
...
async function seed() {
  ...
  const restaurantData = {
    [activeRestId]: {
      ...
      location: new GeoPoint(35.1149, 32.848), // Lefke roughly
      operatingHours: {
    ...
    [inactiveRestId]: {
      ...
      isActive: false,
      commissionRate: 10,
      location: new GeoPoint(35.114, 32.85),
      operatingHours: {},
      cuisineTags: ["pizza"],
    },
  };
  ...
  const orders = [
    ...
    },
    {
      ...
      createdAt: new Date().toISOString(),
      routeWaypoints: [
        new GeoPoint(35.1149, 32.848),
        new GeoPoint(35.1145, 32.849),
      ],
    },
    {
      id: "order3_delivered",
